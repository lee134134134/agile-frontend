  ...
  <el-dialog v-model="addShow" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" class="edit-dia"
    ...
    <div class="dia-main">
      <el-form ref="detailFromRef" :model="detailFrom" :rules="detailRule" class="dia-main-content"
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="迭代名称" prop="name">
              <el-input v-model="detailFrom.name" clearable maxlength="20" placeholder="请输入迭代名称" show-word-limit>
                <!-- <template #suffix>
                  最多20字符
                </template> -->
              </el-input>
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="迭代周期" prop="proDate">
              <el-date-picker v-model="detailFrom.proDate" :disabled="!canDateEdit" clearable
                              end-placeholder="结束日期" format="YYYY-MM-DD" range-separator="-"
                              start-placeholder="开始日期"
                              style="height:32px;border-radius: 4px;" type="daterange" value-format="YYYY-MM-DD"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="可用工作日" prop="period">
              <el-input-number v-model="detailFrom.period" :controls="false" :precision="0" align="left"
                               clearable min="1"
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="所属项目" prop="projectCode">
              <el-select v-model="detailFrom.projectCode" clearable placeholder="请选择">
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="团队" prop="teamName">
              <el-input v-model="detailFrom.teamName" clearable maxlength="20" placeholder="请输入团队" show-word-limit>
                <!-- <template #suffix>
                最多20字符
                </template> -->
              </el-input>
        ...
        <el-row v-for="(domain, index) in detailFrom.members" :key="domain" :gutter="24">
          <el-col :span="12">
            <el-form-item :label="index==0?'团队成员':''" :prop="'members.' + index + '.userAccount'">
              <el-select v-model="domain.userAccount" clearable placeholder="请选择人员">
                <el-option v-for="item in otherRemainUserOptions" :key="item.username" :disabled="assoUserOptions.some(opt => opt.username == item.username)"
                           :label="item.nickname"
                           :value="item.username"/>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="9">
            <el-form-item :prop="'members.' + index + '.availability'" label-width="0px">
              <el-input-number v-model="domain.availability" :controls="false" :precision="1" align="left"
                               clearable max="1" min="0.1"
                               placeholder="请填写可用工时" style="width:100%;"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="3">
            <div style="display: flex;justify-content: end;">
              <el-button class="mini-btn" icon="Plus" type="" @click="addDomain(domain)"></el-button>
              <el-button :disabled="detailFrom.members.length===1" class="mini-btn" icon="Minus" type=""
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="需求分析人" prop="productOwnerAccount">
              <el-select v-model="detailFrom.productOwnerAccount" clearable placeholder="请选择">
          ...
          <el-col :span="12">
            <el-form-item label="Scrum Master" prop="scrumMasterAccount">
              <el-select v-model="detailFrom.scrumMasterAccount" clearable placeholder="请选择">
                <el-option v-for="item in assoUserOptions" :key="item.username" :label="item.nickname"
                           :value="item.username"/>
              </el-select>
            </el-form-item>
