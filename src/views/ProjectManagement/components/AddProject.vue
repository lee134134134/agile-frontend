                ...
                <el-row :gutter="24">
                    <el-col :span="24">
                        <el-form-item label="项目名称" prop="name">
                            <el-input v-model="detailFrom.name" placeholder="请输入项目名称" maxlength="20" clearable></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="24">
                    <el-col :span="12">
                        <el-form-item label="项目状态" prop="state">
                            <el-select v-model="detailFrom.state" placeholder="请选择项目状态" clearable>
                    ...
                    <el-col :span="12">
                        <el-form-item label="项目简称" prop="shortName">
                            <el-input v-model="detailFrom.shortName" placeholder="请输入项目简称" maxlength="20"
                                clearable></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="24">
                    <el-col :span="12">
                        <el-form-item label="项目负责人" prop="projectLeader">
                            <el-select v-model="detailFrom.projectLeader" placeholder="请选择负责人" clearable>
                    ...
                    <el-col :span="12">
                        <el-form-item label="产品负责人">
                            <el-select v-model="detailFrom.productLeader" placeholder="请选择产品负责人" clearable>
                ...
                <el-row :gutter="24">
                    <el-col :span="12">
                        <el-form-item label="需求分析人">
                            <el-select v-model="detailFrom.demandLeader" placeholder="请选择需求分析人" clearable>
                    ...
                    <el-col :span="12">
                        <el-form-item label="Scrum Master：">
                            <el-select v-model="detailFrom.scrumMaster" placeholder="请选择Scrum Master" clearable>
                ...
                <el-row :gutter="24">
                    <el-col :span="12">
                        <el-form-item label="项目英文全称">
                            <el-input v-model="detailFrom.englishName" placeholder="请输入项目英文全称" maxlength="50"
                                clearable></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="实际结束日期">
                            <el-date-picker :clearable="true" v-model="detailFrom.actualEndDate" type="date"
                                placeholder="请输入实际结束日期" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                ...
                <el-row :gutter="24">
                    <el-col :span="12">
                        <el-form-item label="计划开始日期">
                            <el-date-picker :clearable="true" v-model="detailFrom.planStartDate" type="date"
                                placeholder="请输入计划开始日期" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                                :teleported="false"></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="计划结束日期">
                            <el-date-picker :clearable="true" v-model="detailFrom.planEndDate" type="date"
                                placeholder="请输入计划结束日期" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                                :teleported="false"></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="24">
                    <el-col :span="24">
                        <el-form-item label="项目描述">
                            <el-input v-model="detailFrom.projectDescription" placeholder="请输入项目描述" maxlength="200"
                                clearable></el-input>
                        </el-form-item>
