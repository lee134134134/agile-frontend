    ...
    <el-dialog v-model="addShow" :show-close="false" width="996px" @close="handleClose" :close-on-click-modal="false" :close-on-press-escape="false" class="edit-dia">
        ...
        <div class="dia-main">
            <el-form ref="detailFormRef" :model="detailForm" :rules="type == '查看' ? null : detailRule" class="dia-main-content"
                ...
                <el-row :gutter="24">
                    <el-col :span="24">
                        <el-form-item label="上传附件" prop="fileInfo" class="attach-form-item">
                            ...
                            <div class="fileList-area">
                                <div class="file-item" v-for="item in detailForm.fileInfo" :key="item.fileName">
                                    ...
                                    <div class="delete-box jus-bet-center gap12" :class="{'delete-box-disabled': isDisabled}" @click="delAttachment(item.id)">
            ...
            <div class="dia-footer jus-center" v-if="!isDisabled">
...
import { uploadAttach } from '@/api/defectApi';
...
function delAttachment(id) {
    ...
    ElMessageBox.confirm(
        ...
        detailForm.fileIds = detailForm.fileIds.filter(item => item.id != id)
    })
}
