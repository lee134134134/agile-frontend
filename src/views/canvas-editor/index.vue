  ...
  <div class="container">
    <div class="menu" editor-component="menu">
            ...
            <ul>
              ...
              <li data-list-style='checkbox' data-list-type="ul">
                ...
                <ul style="list-style-type: '☑️ ';">
                  <li><img alt="" class="list-item-icon" src="@/assets/webp/icon-1.svg">________</li>
                </ul>
              </li>
              <li data-list-style='disc' data-list-type="ul">
                <label>实心圆点列表：</label>
                <ul style="list-style-type: disc;">
                  <li><img alt="" class="list-item-icon" src="@/assets/webp/icon-2.svg">________</li>
                </ul>
              </li>
              <li data-list-style='circle' data-list-type="ul">
                <label>空心圆点列表：</label>
                <ul style="list-style-type: circle;">
                  <li><img alt="" class="list-item-icon" src="@/assets/webp/icon-3.svg">________</li>
                </ul>
              </li>
              <li data-list-style='square' data-list-type="ul">
                <label>空心方块列表：</label>
                <ul style="list-style-type: square;">
                  <li><img alt="" class="list-item-icon" src="@/assets/webp/icon-4.svg">________</li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <div class="menu-item    disabled-btn">
        ...
        <div class="menu-item__lct" title="流程图">
          <i></i>
        </div>
      </div>
      <div class="menu-divider "></div>
...
const emit = defineEmits(['save-content', 'save-docx']);
...
const saveDoc = async () => {
  const content = instance.value.instance.command.getHTML()
  let html = `<!DOCTYPE html><html><head><meta http=equiv="Content-type" content="text/html;charset=UTF-8"></head><body>${content.main}</body></html>`;
  let converd = htmlDocx.asBlob(html)
  let myBaseValue = instance.value.instance.command.getValue()
  emit('save-docx', {'baseValue': myBaseValue, converd: converd})
};
